// Lucide-style SVG icons (home, dumbbell, clock, list, menu, close)
// Manually extracted from Lucide icon set
...
export const icons = {
  ...
  dumbbell: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6.5 6.5 11 11"/><path d="m6.5 17.5 11-11"/><path d="M14 4l2-2 4 4-2 2"/><path d="M10 20l-2 2-4-4 2-2"/><path d="M20 10l2-2-4-4-2 2"/><path d="M4 14l-2 2 4 4 2-2"/></svg>`,
  ...
  layers: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.57 3.9a2 2 0 0 0 1.66 0l8.57-3.9a1 1 0 0 0 0-1.83Z"/><path d="m22 17.65-9.17 4.16a2 2 0 0 1-1.66 0L2 17.65"/><path d="m22 12.65-9.17 4.16a2 2 0 0 1-1.66 0L2 12.65"/></svg>`,
