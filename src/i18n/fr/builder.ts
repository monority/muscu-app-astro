export default {
  ...
  supersetSuggest: 'Enchaîner en superset ?',
  supersetGroupBtn: 'Grouper en superset',
  supersetWith: 'avec',
  supersetDismiss: 'Ignorer la suggestion',
  supersetRemove: 'Retirer du superset',
  supersetHint: 'Séries terminées à la suite : enchaînez deux exercices différents sans repos.',
