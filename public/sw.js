...
// /sessions/<id> URLs are NOT precached; they're cached on first
...
const APP_SHELL = [
  ...
  "/en/exercises",
  "/en/exercises/trends",
  "/en/exercises/history",
  "/en/progression",
  "/en/progression/stats",
  "/en/progression/records",
  "/en/progression/poids",
  "/en/settings",
  "/en/timer",
  "/en/calendar",
  "/en/calculator",
